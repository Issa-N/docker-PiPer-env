...
class C_PiperRosNode():
    ...
    def __init__(self) -> None:
        ...
        self.end_grip_pose_feedback_pub = rospy.Publisher('end_grip_pose_feedback', PosCmd, queue_size=1)#develop
        # service
    ...
    def Pubilsh(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.PublishEndEffectorStateAsPosCmd() ##develop
            rate.sleep()
    ...
    ###Develop (/pos_cmdトピックに合わせた形式のpublisher) 
    def PublishEndEffectorStateAsPosCmd(self):
        ### 手先位置
        msg = PosCmd()
        msg.x = self.piper.GetArmEndPoseMsgs().end_pose.X_axis / 1000000
        msg.y = self.piper.GetArmEndPoseMsgs().end_pose.Y_axis / 1000000
        msg.z = self.piper.GetArmEndPoseMsgs().end_pose.Z_axis / 1000000
        ### 手先角度
        roll = self.piper.GetArmEndPoseMsgs().end_pose.RX_axis/1000
        pitch = self.piper.GetArmEndPoseMsgs().end_pose.RY_axis/1000
        yaw = self.piper.GetArmEndPoseMsgs().end_pose.RZ_axis/1000
        ...
        ### グリッパー
        msg.gripper = self.piper.GetArmGripperMsgs().gripper_state.grippers_angle/1000000
        ### 仮変数
        msg.mode1 = 0
        msg.mode2 = 0

        self.end_grip_pose_feedback_pub.publish(msg)
